...
DetailMoviesResponse detailMoviesResponseFromJson(String str) =>
    DetailMoviesResponse.fromJson(json.decode(str));

String detailMoviesResponseToJson(DetailMoviesResponse data) =>
    json.encode(data.toJson());

class DetailMoviesResponse {
  final bool adult;
